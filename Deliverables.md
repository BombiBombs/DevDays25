...
| :--- | :--- | :--- | :--- |
| **GET** | `/weathers` | `getAllWeathers` | Lista todos los datos climáticos. |
...
| **GET** | `/audits/city/:ciudad` | `findAuditByCity` | Encuentra las auditorias de dicha ciudad segun el parametro de la peticion. |
---
...
#### 3. Búsqueda Dinámica y Flexibilidad de Localización
...
#### 4. Visualización y Exposición de Datos
